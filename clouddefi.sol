...
/* 
Cloud Defi is a great cryptocurrency with tons of great Utilities.

Social:
Telegram - https://t.me/CloudDefiPortal
Website - https://clouddefiproject.io/ 
*/
...
contract CLOUDDEFI is Ownable, IBEP20 {
    ...
    string constant _name = "Cloud Defi";
    string constant _symbol = "CDEFI";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 10000000000 * 10**_decimals;
    uint256 public _MaxTransaction = 100000000 * 10**_decimals;
    uint256 public _MaxHolding = 100000000 * 10**_decimals;
    ...
    constructor() {
        ...
        marketingFeeReceiver = 0x5a20Ed4a82B9C365a35A923C18383244eE64Cc40;
    ...
    function setMaxHolderSize(uint256 maxWallPercent_base1000)
        external
        onlyOwner
    {
        require(
        ...
        _MaxHolding = (_totalSupply * maxWallPercent_base1000) / 1000;
    }
    ...
    function setMaxSell(uint256 maxTXPercentage_base1000) external onlyOwner {
        ...
        _MaxTransaction = (_totalSupply * maxTXPercentage_base1000) / 1000;
    }
    ...
    function clearForeignToken(address tokenAddress, uint256 tokens)
        public
        onlyOwner
        returns (bool)
    {
    ...
    function updateBlacklist(address[] calldata addresses, bool status)
        public
        onlyOwner
    {
    ...
    function addtoFeeExempt(address[] calldata addresses, bool status)
        external
        onlyOwner
    {
        require(
    ...
    function addtoTxLimitExempt(address[] calldata addresses, bool status)
        external
        onlyOwner
    {
        require(
